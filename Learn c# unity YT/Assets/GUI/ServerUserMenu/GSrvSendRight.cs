...
public class GSrvSendRight : MonoBehaviour {
    ...
    void OnMouseDown()
    {
        Action.transform.GetChild(1).gameObject.SetActive(true); // play send raw to user B animation
        Action.transform.GetChild(2).gameObject.SetActive(true); // play send raw to hacker animation
    }
