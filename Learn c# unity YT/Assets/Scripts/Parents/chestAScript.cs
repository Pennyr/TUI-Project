...
public class chestAScript : MonoBehaviour {
    ...
    public bool initialOnce { get; set; } //when chest is placed. for use by other objects
    public bool A_KeyIn { get; set; } //when key is inserted. for use by other objects
    ...
    void OnTriggerStay2D(Collider2D other)
    {
        ...
        {
            //Debug.Log("Trigger Stay Chest Script");
    ...
    {
        //Debug.Log("Trigger Exit Chest Script");
